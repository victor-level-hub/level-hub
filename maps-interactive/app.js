...
function MapasInterativo({ full = false }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "level-field", style: { minHeight: "100vh", backgroundImage: "radial-gradient(55% 60% at 50% 0%, rgba(255,152,0,0.10), transparent 60%), radial-gradient(50% 60% at 0% 100%, rgba(88,196,220,0.06), transparent 55%), linear-gradient(160deg, #161d33, #111626)", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "sticky", top: 0, zIndex: 60, background: "rgba(10,13,22,0.6)", backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)", borderBottom: "1px solid rgba(174,199,224,0.10)" } }, /* @__PURE__ */ React.createElement("div", { style: { maxWidth: 1680, margin: "0 auto", minHeight: 64, padding: "10px 28px", display: "flex", alignItems: "center", gap: 22, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 19, letterSpacing: "0.16em", color: "var(--level-orange)" } }, "LEVEL"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", lineHeight: 1.1 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 18, letterSpacing: "0.06em", color: "var(--text-heading)" } }, u("pageTitle")), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.08em", color: "var(--level-blue)" } }, MAP.name, " \xB7 ", tt(MAP.mode))), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("label", { style: { display: "flex", alignItems: "center", gap: 7 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: 9, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--text-faint)" } }, u("langUI")), /* @__PURE__ */ React.createElement(Seg, { value: uiLang, onChange: setUiLang, accent: "var(--level-blue)", options: [{ value: "pt", label: "PT" }, { value: "en", label: "EN" }] })), /* @__PURE__ */ React.createElement("label", { style: { display: "flex", alignItems: "center", gap: 7 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: 9, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--text-faint)" } }, u("langTech")), /* @__PURE__ */ React.createElement(Seg, { value: techLang, onChange: setTechLang, accent: "var(--level-blue)", options: [{ value: "pt", label: "PT" }, { value: "en", label: "EN" }] })), /* @__PURE__ */ React.createElement("label", { style: { display: "flex", alignItems: "center", gap: 7 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: 9, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--text-faint)" } }, u("direction")), /* @__PURE__ */ React.createElement(Seg, { value: dir, onChange: setDir, options: [{ value: "A", label: u("dirA") }, { value: "B", label: u("dirB") }] })), /* @__PURE__ */ React.createElement("button", { onClick: () => setIsFull(true), title: u("maximize"), style: { display: "inline-flex", alignItems: "center", gap: 7, cursor: "pointer", border: "1px solid rgba(255,152,0,0.4)", background: "rgba(255,152,0,0.1)", color: "var(--level-orange)", borderRadius: 8, padding: "7px 12px", fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.06em", textTransform: "uppercase" } }, /* @__PURE__ */ React.createElement(Icon, { name: "expand", size: 14, color: "var(--level-orange)", sw: 2.2 }), u("maximize"))))), /* @__PURE__ */ React.createElement("div", { className: "mi-body", style: { flex: 1, maxWidth: 1680, width: "100%", margin: "0 auto", padding: "20px 28px 40px" } }, /* @__PURE__ */ React.createElement("div", { className: "mi-layers", style: glass({ padding: 16, alignSelf: "start", position: "sticky", top: 84 }) }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-mono)", fontSize: 10.5, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--text-secondary)" } }, u("layers")), /* @__PURE__ */ React.createElement("span", { style: { display: "flex", gap: 6 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setActive(new Set(LAYERS.map((l) => l.id))), style: miniBtn(allOn) }, u("showAll")), /* @__PURE__ */ React.createElement("button", { onClick: () => setActive(/* @__PURE__ */ new Set()), style: miniBtn(false) }, u("clear")))), /* @__PURE__ */ React.createElement("div", { style: { fontFamily: "var(--font-mono)", fontSize: 9.5, color: "var(--text-faint)", margin: "7px 0 12px" } }, active.size, "/", LAYERS.length, " ", u("visible")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, LAYERS.map((l) => {
...
function FullView({ neon, dir, setDir, uiLang, setUiLang, techLang, setTechLang, active, toggleLayer, setActive, visibleFeatures, sel, setSel, hover, setHover, selFeature, focusTeam, t, tt, u, allOn, onExit }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { height: "100vh", minHeight: "100vh", width: "100%", background: "#0B0F1A", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "none", display: "flex", alignItems: "center", gap: 12, padding: "8px 14px", minHeight: 54, background: "rgba(10,13,22,0.9)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", borderBottom: "1px solid rgba(174,199,224,0.1)", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 16, letterSpacing: "0.16em", color: "var(--level-orange)" } }, "LEVEL"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 15, letterSpacing: "0.04em", color: "var(--text-heading)" } }, MAP.name), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 5, flexWrap: "wrap", flex: 1, justifyContent: "center" } }, LAYERS.map((l) => {
    const on = active.has(l.id);
