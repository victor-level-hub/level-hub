...
function FullView({ neon, dir, setDir, uiLang, setUiLang, techLang, setTechLang, active, toggleLayer, setActive, visibleFeatures, sel, setSel, hover, setHover, selFeature, focusTeam, t, tt, u, allOn, onExit }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { height: "100vh", minHeight: "100vh", width: "100%", background: "#0B0F1A", display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React.createElement("div", { style: { flex: "none", display: "flex", alignItems: "center", gap: 12, padding: "8px 14px", minHeight: 54, background: "rgba(10,13,22,0.9)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", borderBottom: "1px solid rgba(174,199,224,0.1)", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("img", { src: "level-logo.svg", alt: "", style: { height: 22, display: "block" } }), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-display)", fontWeight: 800, fontSize: 16, letterSpacing: "0.16em", color: "var(--level-orange)" } }, "LEVEL"), /* @__PURE__ */ React.createElement("span", { style: { fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 15, letterSpacing: "0.04em", color: "var(--text-heading)" } }, MAP.name), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 5, flexWrap: "wrap", flex: 1, justifyContent: "center" } }, LAYERS.map((l) => {
    const on = active.has(l.id);
